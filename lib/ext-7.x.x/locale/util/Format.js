...
Ext.define( "Ext.locale.util.Format", {
    ...
    currency ( value, format ) {
        ...
        if ( !format ) {
            formatter = intlCurrencyFormatters[""] ??= new Intl.NumberFormat( locale.intlLocale, {
                "style": "currency",
            ...
            formatter = intlCurrencyFormatters[format];

            if ( !formatter ) {
                parsedFormat.style = "currency";
                parsedFormat.currency ||= locale.defaultCurrency;

                formatter = intlCurrencyFormatters[format] = new Intl.NumberFormat( locale.intlLocale, parsedFormat );
            }
        }
