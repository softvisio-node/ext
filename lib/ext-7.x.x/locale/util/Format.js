...
Ext.define( "Ext.locale.util.Format", {
    ...
    date ( value, format ) {
        ...
        if ( !format ) {
            ...
            const parsedFormat = this.parseIntlFormat( format );
    ...
    percent ( value, format ) {
        if ( !format ) {
            return this.number( value, "style:percent" );
        }
        else if ( typeof format === "string" ) {
            ...
            return this.number( value, { ...format, "style": "percent" } );
        }
    },
