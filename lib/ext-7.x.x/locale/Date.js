...
const monthLong = new Intl.DateTimeFormat( locale.name, { "month": "long" } );
const monthShort = new Intl.DateTimeFormat( locale.name, { "month": "short" } );
const weekDayLong = new Intl.DateTimeFormat( locale.name, { "weekday": "long" } );
const weekDayShort = new Intl.DateTimeFormat( locale.name, { "weekday": "short" } );
