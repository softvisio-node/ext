    ...
    privates: {
        ...
        doRecalculate: function(start) {
            ...
            start = D.subtract(value, D.DAY, startOffset);
                ...
                start, D.DAY, visibleWeeks * daysInWeek - (daysInWeek - me.getVisibleDays())
            );
        ...
        doRefresh: function() {
            var me = this,
                ...
                m = now.getMonth(),
                d = now.getDate(),
                cells, len, i, cell, firstDate, lastDate, highlight;
        ...
        getDaySizes: function() {
            ...
            if (!me.daySizes) {
                ...
                headerHeight = fly.getPadding('tb') +
                               Ext.fly(cell.firstChild.firstChild).getHeight();
        ...
        positionEvent: function(el, item) {
            ...
            headerOffset =
                daySizes.headerHeight + eventStyle.height * idx + (idx + 1) * margin.height;
            ...
            for (i = 0; i < days; ++i) {
                ...
                if (overflow && overflow.length && showOverflow) {
                    ...
                    cell.firstChild.lastChild.innerHTML =
                        Ext.String.format(overflowText, overflow.length);
                }
                else {
