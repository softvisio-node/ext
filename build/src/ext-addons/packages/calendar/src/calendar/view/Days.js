...
Ext.define('Ext.calendar.view.Days', {
        ...
        result.children = [{
            ...
            children: [{
                ...
                children: [{
                    ...
                    children: [{
                        tag: 'table',
                        cls: me.$tableCls + ' ' + Ext.baseCSSPrefix +
                             'calendar-days-allday-background-table',
                        children: [{
                            tag: 'tbody',
                            children: [{
                                tag: 'tr',
    ...
    privates: {
        ...
        doRefresh: function() {
            ...
            me.clearAndPopulate(
                me.allDayEmptyRow, me.generateAllDayCells(me.$allDayEmptyRowCls, '&#160;'), true
            );

            me.clearAndPopulate(
                allDayBackgroundRow, me.generateAllDayCells(me.$allDayBackgroundCls)
            );
