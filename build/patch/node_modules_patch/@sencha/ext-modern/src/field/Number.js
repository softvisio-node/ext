...
Ext.define('Ext.field.Number', {
     ...
     * @since 6.5.1
     */
    minValueText: window.l10n( "The minimum value for this field is {0}" ),
     ...
     * @since 6.5.1
     */
    maxValueText: window.l10n( "The maximum value for this field is {0}" ),
     ...
     * @since 6.5.1
     */
    decimalsText: window.l10n( "The maximum decimal places is {0}" ),

    badFormatMessage: window.l10n( "Value is not a valid number" ),
