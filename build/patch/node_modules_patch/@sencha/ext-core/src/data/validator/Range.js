...
Ext.define('Ext.data.validator.Range', {
     ...
     * @locale
     */
    minOnlyMessage: window.l10nd( "ext", "Must be at least {0}" ),
     ...
     * @locale
     */
    maxOnlyMessage: window.l10nd( "ext", "Must be no more than than {0}" ),
     ...
     * @locale
     */
    bothMessage: window.l10nd( "ext", "Must be between {0} and {1}" ),
