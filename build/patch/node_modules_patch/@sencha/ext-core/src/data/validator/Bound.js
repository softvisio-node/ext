...
Ext.define('Ext.data.validator.Bound', {
    ...
    config: {
         ...
         * @locale
         */
        emptyMessage: window.l10nd( "ext", "Must be present" ),
         ...
         * @locale
         */
        minOnlyMessage: window.l10nd( "ext", "Value must be greater than {0}" ),
         ...
         * @locale
         */
        maxOnlyMessage: window.l10nd( "ext", "Value must be less than {0}" ),
         ...
         * @locale
         */
        bothMessage: window.l10nd( "ext", "Value must be between {0} and {1}" )
    },
