...
Ext.define('Ext.data.validator.Bound', {
    ...
    config: {
         ...
         * @locale
         */
        emptyMessage: window.l10n( "Must be present", { domain: "ext" } ),
         ...
         * @locale
         */
        minOnlyMessage: window.l10n( "Value must be greater than {0}", { domain: "ext" } ),
         ...
         * @locale
         */
        maxOnlyMessage: window.l10n( "Value must be less than {0}", { domain: "ext" } ),
         ...
         * @locale
         */
        bothMessage: window.l10n( "Value must be between {0} and {1}", { domain: "ext" } )
    },
