...
Ext.define('Ext.data.validator.Length', {
     ...
     * @locale
     */
    minOnlyMessage: window.l10nd( "ext", "Length must be at least {0}" ),
     ...
     * @locale
     */
    maxOnlyMessage: window.l10nd( "ext", "Length must be no more than {0}" ),
     ...
     * @locale
     */
    bothMessage: window.l10nd( "ext", "Length must be between {0} and {1}" ),
