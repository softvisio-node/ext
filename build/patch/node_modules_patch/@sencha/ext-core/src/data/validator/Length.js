...
Ext.define('Ext.data.validator.Length', {
     ...
     * @locale
     */
    minOnlyMessage: window.l10n( "Length must be at least {0}", { domain: "ext" } ),
     ...
     * @locale
     */
    maxOnlyMessage: window.l10n( "Length must be no more than {0}", { domain: "ext" } ),
     ...
     * @locale
     */
    bothMessage: window.l10n( "Length must be between {0} and {1}", { domain: "ext" } ),
