...
export default class Ext_viewport_WP extends Ext_viewport_Default {
    static PROPERTIES () {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_viewport_WP.PROPERTIES() );
        return Ext_viewport_Default.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_viewport_WP.EVENTS() );
        return Ext_viewport_Default.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_viewport_WP.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_viewport_WP.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_viewport_WP.PROPERTIES() ), events.concat( Ext_viewport_WP.EVENTS() ) );
    }
