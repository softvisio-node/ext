...
export default class Ext_grid_row_Group extends Ext_grid_Row {
    static PROPERTIES () {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_grid_row_Group.PROPERTIES() );
        return Ext_grid_Row.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_grid_row_Group.EVENTS() );
        return Ext_grid_Row.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_grid_row_Group.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_grid_row_Group.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_grid_row_Group.PROPERTIES() ), events.concat( Ext_grid_row_Group.EVENTS() ) );
    }
