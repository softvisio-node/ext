...
export default class Ext_grid_row_Summary extends Ext_grid_Row {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_grid_row_Summary.PROPERTIES() );
        return Ext_grid_Row.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_grid_row_Summary.EVENTS() );
        return Ext_grid_Row.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_grid_row_Summary.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_grid_row_Summary.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_grid_row_Summary.PROPERTIES() ), events.concat( Ext_grid_row_Summary.EVENTS() ) );
    }
