...
export default class Ext_grid_plugin_grouping_Panel extends Ext_Panel {
    static PROPERTIES () {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_grid_plugin_grouping_Panel.PROPERTIES() );
        return Ext_Panel.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_grid_plugin_grouping_Panel.EVENTS() );
        return Ext_Panel.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_grid_plugin_grouping_Panel.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_grid_plugin_grouping_Panel.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_grid_plugin_grouping_Panel.PROPERTIES() ), events.concat( Ext_grid_plugin_grouping_Panel.EVENTS() ) );
    }
