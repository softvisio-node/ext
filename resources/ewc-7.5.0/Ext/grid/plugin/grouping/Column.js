...
export default class Ext_grid_plugin_grouping_Column extends Ext_Component {
    static PROPERTIES () {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_grid_plugin_grouping_Column.PROPERTIES() );
        return Ext_Component.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_grid_plugin_grouping_Column.EVENTS() );
        return Ext_Component.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_grid_plugin_grouping_Column.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_grid_plugin_grouping_Column.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_grid_plugin_grouping_Column.PROPERTIES() ), events.concat( Ext_grid_plugin_grouping_Column.EVENTS() ) );
    }
