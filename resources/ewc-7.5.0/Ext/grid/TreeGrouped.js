...
export default class Ext_grid_TreeGrouped extends Ext_grid_Grid {
    ...
    static EVENTS () {
        return [
            ...
            { "name": "beforegroupSummaryPositionchange", "parameters": "sender,value,oldValue,undefined" },
            ...
            { "name": "beforesummaryPositionchange", "parameters": "sender,value,oldValue,undefined" },
            ...
            { "name": "groupcontextmenu", "parameters": "sender,params,e" },
            { "name": "groupdoubletap", "parameters": "sender,params,e" },
            { "name": "groupexpand", "parameters": "sender,group" },
            { "name": "groupsingletap", "parameters": "sender,params,e" },
            { "name": "groupsummarycontextmenu", "parameters": "sender,params,e" },
            { "name": "groupsummarydoubletap", "parameters": "sender,params,e" },
            { "name": "groupSummaryPositionchange", "parameters": "sender,value,oldValue" },
            { "name": "groupsummarysingletap", "parameters": "sender,params,e" },
            { "name": "groupsummarytap", "parameters": "sender,params,e" },
            { "name": "groupsummarytaphold", "parameters": "sender,params,e" },
            { "name": "grouptap", "parameters": "sender,params,e" },
            { "name": "grouptaphold", "parameters": "sender,params,e" },
            ...
            { "name": "summaryPositionchange", "parameters": "sender,value,oldValue" },
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_grid_TreeGrouped.PROPERTIES() );
        return Ext_grid_Grid.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_grid_TreeGrouped.EVENTS() );
        return Ext_grid_Grid.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_grid_TreeGrouped.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_grid_TreeGrouped.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_grid_TreeGrouped.PROPERTIES() ), events.concat( Ext_grid_TreeGrouped.EVENTS() ) );
    }
