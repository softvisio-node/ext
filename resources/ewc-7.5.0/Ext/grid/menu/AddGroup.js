...
export default class Ext_grid_menu_AddGroup extends Ext_menu_Item {
    static PROPERTIES () {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_grid_menu_AddGroup.PROPERTIES() );
        return Ext_menu_Item.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_grid_menu_AddGroup.EVENTS() );
        return Ext_menu_Item.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_grid_menu_AddGroup.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_grid_menu_AddGroup.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_grid_menu_AddGroup.PROPERTIES() ), events.concat( Ext_grid_menu_AddGroup.EVENTS() ) );
    }
