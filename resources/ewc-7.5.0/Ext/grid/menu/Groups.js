...
export default class Ext_grid_menu_Groups extends Ext_menu_Item {
    static PROPERTIES () {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_grid_menu_Groups.PROPERTIES() );
        return Ext_menu_Item.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_grid_menu_Groups.EVENTS() );
        return Ext_menu_Item.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_grid_menu_Groups.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_grid_menu_Groups.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_grid_menu_Groups.PROPERTIES() ), events.concat( Ext_grid_menu_Groups.EVENTS() ) );
    }
