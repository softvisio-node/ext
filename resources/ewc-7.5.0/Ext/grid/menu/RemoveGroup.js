...
export default class Ext_grid_menu_RemoveGroup extends Ext_menu_Item {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_grid_menu_RemoveGroup.PROPERTIES() );
        return Ext_menu_Item.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_grid_menu_RemoveGroup.EVENTS() );
        return Ext_menu_Item.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_grid_menu_RemoveGroup.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_grid_menu_RemoveGroup.EVENTS().forEach( function ( eventparameter, index, array ) {
