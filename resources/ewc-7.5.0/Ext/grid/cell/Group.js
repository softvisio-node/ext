...
export default class Ext_grid_cell_Group extends Ext_grid_cell_Cell {
    static PROPERTIES () {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_grid_cell_Group.PROPERTIES() ), events.concat( Ext_grid_cell_Group.EVENTS() ) );
    }
