...
export default class Ext_grid_column_Selection extends Ext_grid_column_Check {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_grid_column_Selection.PROPERTIES() ), events.concat( Ext_grid_column_Selection.EVENTS() ) );
    }
