...
export default class Ext_grid_column_RowNumberer extends Ext_grid_column_Number {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_grid_column_RowNumberer.PROPERTIES() ), events.concat( Ext_grid_column_RowNumberer.EVENTS() ) );
    }
