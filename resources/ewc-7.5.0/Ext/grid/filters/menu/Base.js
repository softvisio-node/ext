...
export default class Ext_grid_filters_menu_Base extends Ext_menu_CheckItem {
    static PROPERTIES () {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_grid_filters_menu_Base.PROPERTIES() );
        return Ext_menu_CheckItem.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_grid_filters_menu_Base.EVENTS() );
        return Ext_menu_CheckItem.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_grid_filters_menu_Base.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_grid_filters_menu_Base.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_grid_filters_menu_Base.PROPERTIES() ), events.concat( Ext_grid_filters_menu_Base.EVENTS() ) );
    }
