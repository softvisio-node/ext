import Ext_grid_filters_menu_Base from "../../../../Ext/grid/filters/menu/Base.js";

export default class Ext_grid_filters_menu_Boolean extends Ext_grid_filters_menu_Base {
    static PROPERTIES () {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_grid_filters_menu_Boolean.PROPERTIES() );
        return Ext_grid_filters_menu_Base.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_grid_filters_menu_Boolean.EVENTS() );
        return Ext_grid_filters_menu_Base.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_grid_filters_menu_Boolean.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_grid_filters_menu_Boolean.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_grid_filters_menu_Boolean.PROPERTIES() ), events.concat( Ext_grid_filters_menu_Boolean.EVENTS() ) );
    }
