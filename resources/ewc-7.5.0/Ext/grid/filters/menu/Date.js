...
export default class Ext_grid_filters_menu_Date extends Ext_grid_filters_menu_Base {
    static PROPERTIES () {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_grid_filters_menu_Date.PROPERTIES() );
        return Ext_grid_filters_menu_Base.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_grid_filters_menu_Date.EVENTS() );
        return Ext_grid_filters_menu_Base.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_grid_filters_menu_Date.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_grid_filters_menu_Date.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_grid_filters_menu_Date.PROPERTIES() ), events.concat( Ext_grid_filters_menu_Date.EVENTS() ) );
    }
