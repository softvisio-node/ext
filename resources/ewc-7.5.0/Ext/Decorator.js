...
export default class Ext_Decorator extends Ext_Component {
    static PROPERTIES () {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_Decorator.PROPERTIES() );
        return Ext_Component.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_Decorator.EVENTS() );
        return Ext_Component.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_Decorator.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_Decorator.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_Decorator.PROPERTIES() ), events.concat( Ext_Decorator.EVENTS() ) );
    }
