...
export default class Ext_chart_navigator_Navigator extends Ext_chart_navigator_NavigatorBase {
    static PROPERTIES () {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_chart_navigator_Navigator.PROPERTIES() ), events.concat( Ext_chart_navigator_Navigator.EVENTS() ) );
    }
