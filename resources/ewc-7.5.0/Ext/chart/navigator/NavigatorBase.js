import Ext_chart_CartesianChart from "../../../Ext/chart/CartesianChart.js";

export default class Ext_chart_navigator_NavigatorBase extends Ext_chart_CartesianChart {
    static PROPERTIES () {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_chart_navigator_NavigatorBase.PROPERTIES() );
        return Ext_chart_CartesianChart.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_chart_navigator_NavigatorBase.EVENTS() );
        return Ext_chart_CartesianChart.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_chart_navigator_NavigatorBase.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_chart_navigator_NavigatorBase.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_chart_navigator_NavigatorBase.PROPERTIES() ), events.concat( Ext_chart_navigator_NavigatorBase.EVENTS() ) );
    }
