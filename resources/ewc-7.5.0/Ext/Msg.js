...
export default class Ext_Msg extends Ext_MessageBox {
    static PROPERTIES () {
    ...
    static getProperties ( properties ) {
        ...
        return Ext_MessageBox.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_Msg.EVENTS() );
        return Ext_MessageBox.getEvents( events );
    }
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_Msg.PROPERTIES() ), events.concat( Ext_Msg.EVENTS() ) );
    }
