...
export default class Ext_dataview_plugin_ItemTip extends Ext_tip_ToolTip {
    static PROPERTIES () {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_dataview_plugin_ItemTip.PROPERTIES() ), events.concat( Ext_dataview_plugin_ItemTip.EVENTS() ) );
    }
