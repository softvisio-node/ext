...
export default class Ext_carousel_Item extends Ext_Decorator {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_carousel_Item.PROPERTIES() );
        return Ext_Decorator.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_carousel_Item.EVENTS() );
        return Ext_Decorator.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_carousel_Item.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_carousel_Item.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_carousel_Item.PROPERTIES() ), events.concat( Ext_carousel_Item.EVENTS() ) );
    }
