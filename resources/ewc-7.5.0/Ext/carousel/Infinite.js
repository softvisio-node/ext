import Ext_carousel_Carousel from "../../Ext/carousel/Carousel.js";
...
export default class Ext_carousel_Infinite extends Ext_carousel_Carousel {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_carousel_Infinite.PROPERTIES() );
        return Ext_carousel_Carousel.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_carousel_Infinite.EVENTS() );
        return Ext_carousel_Carousel.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_carousel_Infinite.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_carousel_Infinite.EVENTS().forEach( function ( eventparameter, index, array ) {
