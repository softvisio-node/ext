...
export default class Ext_field_trigger_Operator extends Ext_field_trigger_Trigger {
    static PROPERTIES () {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_field_trigger_Operator.PROPERTIES() ), events.concat( Ext_field_trigger_Operator.EVENTS() ) );
    }
