...
export default class Ext_Toast extends Ext_Sheet {
    ...
    static getProperties ( properties ) {
        properties = properties.concat( Ext_Toast.PROPERTIES() );
        return Ext_Sheet.getProperties( properties );
    }

    static getEvents ( events ) {
        events = events.concat( Ext_Toast.EVENTS() );
        return Ext_Sheet.getEvents( events );
    }

    static get observedAttributes () {
        var attrs = super.observedAttributes;
        Ext_Toast.PROPERTIES().forEach( function ( property, index, array ) {
            attrs.push( property );
        } );
        Ext_Toast.EVENTS().forEach( function ( eventparameter, index, array ) {
    ...
    constructor ( properties, events ) {
        super( properties.concat( Ext_Toast.PROPERTIES() ), events.concat( Ext_Toast.EVENTS() ) );
    }
